...
1. ✅ Master discovery frameworks (OST, JTBD deep dive)
2. ✅ Understand the complete ML project lifecycle
3. ✅ Know how to evaluate AI project feasibility
4. ✅ Identify data requirements and constraints
5. ✅ Build a systematic approach to AI opportunity selection
...
- **Learning:**
  ...
  - How to build an OST: Outcome → Opportunities → Solutions → Experiments
  - Continuous discovery mindset
- **Resources:**
  - 📚 [Teresa Torres - Continuous Discovery Habits](https://www.producttalk.org/opportunity-solution-tree/) (Read: Chapter on OST)
  - 🎥 [How to Create an Opportunity Solution Tree](https://www.youtube.com/watch?v=l6vQ5Oc3y0A) - Teresa Torres
  - 📖 [OST Template & Guide](https://www.producttalk.org/2023/08/opportunity-solution-trees/)
...
- **Learning:**
  ...
  - JTBD vs. personas
- **Resources:**
  - 📚 [Competing Against Luck](https://www.christenseninstitute.org/jobs-to-be-done/) - Key chapters
  - 🎥 [Bob Moesta - JTBD Masterclass](https://www.youtube.com/results?search_query=bob+moesta+jobs+to+be+done)
  - 📖 [Intercom's JTBD Guide](https://www.intercom.com/blog/using-job-stories-design-features-ui-ux/)
...
- **Resources:**
  - 📚 [The Mom Test](https://www.momtestbook.com/) - Rob Fitzpatrick (Read key chapters)
  - 🎥 [How to Do User Interviews](https://www.youtube.com/watch?v=qAws7eXItMk) - YC Startup School
  - 📖 [Teresa Torres - Discovery Interviews](https://www.producttalk.org/2022/03/discovery-interviews/)
...
- **Resources:**
  - 📚 [Google's ML Workflow](https://cloud.google.com/architecture/mlops-continuous-delivery-and-automation-pipelines-in-machine-learning)
  - 🎥 [Andrew Ng - ML Project Lifecycle](https://www.deeplearning.ai/courses/machine-learning-engineering-for-production-mlops/)
  - 📖 [Full Stack Deep Learning - ML Projects](https://fullstackdeeplearning.com/course/2022/)
  - 📖 [Chip Huyen - Designing ML Systems](https://huyenchip.com/machine-learning-systems-design/toc.html)
...
- **Resources:**
  - 📚 [AI Project Canvas](https://www.oreilly.com/library/view/practical-deep-learning/9781492034858/) - Chapter on project selection
  - 📖 [Andrew Ng - AI Transformation Playbook](https://landing.ai/resources/ai-transformation-playbook/)
  - 📖 [a16z - How to Choose AI Projects](https://a16z.com/2016/06/10/ai-deep-learning-startup/)
...
- **Resources:**
  - 📖 [Why AI Projects Fail](https://sloanreview.mit.edu/article/why-ai-projects-fail/)
  - 📖 [Google's ML Rules](https://developers.google.com/machine-learning/guides/rules-of-ml)
...
- **Books:**
  - 📚 *Continuous Discovery Habits* - Teresa Torres ⭐ MUST READ
...
- **Courses:**
  - 🎓 [Andrew Ng - MLOps Specialization](https://www.deeplearning.ai/courses/machine-learning-engineering-for-production-mlops/) ⭐
  - 🎓 [Full Stack Deep Learning](https://fullstackdeeplearning.com/) ⭐
  - 🎓 [Google Cloud - ML Engineering](https://www.cloudskillsboost.google/paths/17)

- **Books & Guides:**
  - 📚 *Designing Machine Learning Systems* - Chip Huyen ⭐ MUST READ
...
- **Frameworks:**
  ...
  - 📖 [Microsoft - Human-AI Guidelines](https://www.microsoft.com/en-us/research/project/guidelines-for-human-ai-interaction/)
...
### Discovery:
- **Opportunity Solution Tree:** Framework connecting outcomes → opportunities → solutions → experiments
...
|-----|-------|----------------|--------|
| Mon | Opportunity Solution Trees | __ / 4 | ⬜ |
| Tue | JTBD Deep Dive | __ / 4 | ⬜ |
| Wed | Discovery Interviews | __ / 4 | ⬜ |
| Thu | ML Project Lifecycle | __ / 4 | ⬜ |
| Fri | AI Project Selection | __ / 4 | ⬜ |
| Sat-Sun | Apply Framework & Case Studies | __ / 5 | ⬜ |
...
✅ You can explain OST and JTBD frameworks fluently
✅ You can map the ML project lifecycle for any AI product
✅ You have a repeatable framework for choosing AI projects
✅ You can conduct a discovery interview
✅ You understand the PM role in ML projects

Let's build world-class discovery skills! 🚀
